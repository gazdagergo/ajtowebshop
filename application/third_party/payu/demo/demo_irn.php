...
<div class="container">
	<div class="row clearfix">
		<div class="col-md-12 column">
			...
			<div class="page-header">
				<h1>
					[ IRN ] <small><?php echo IRN_PAGE_TITLE; ?></small>
				</h1>
			</div>
			<div class="row clearfix">
				<div class="col-md-8 column">
					...
					<div class="tab-content">			
						...
						Order ref: <b><?php print $response['IRN_DATE'];?></b><br/>
					</div>
					
					<p>Az IRN eredményét a kereskedői vezérlőpulton a <b><?php print $response['ORDER_REF'];?></b> tranzakció adatainál tudja nyomon követni</p>
	...
	<div class="row clearfix">
		<div class="col-md-4 column">
			...
			<?php echo $irn->sdkVersion(); ?><br>
			<a href="mailto:support@payu.hu?Subject=Support: <?php echo $irn->sdkVersion(); ?>" target="_top">support@payu.hu</a><br>
