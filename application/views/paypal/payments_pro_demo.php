...
<p><?php highlight_file($_SERVER['DOCUMENT_ROOT'].'/application/views/paypal/get_balance.php'); ?></p>
...
<p>
  <!--?php highlight_file($_SERVER['DOCUMENT_ROOT'].'/application/controllers/paypal/payments_pro.php'); ?-->
</p>
