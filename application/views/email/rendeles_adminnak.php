...
** Quick modification **
We are using width of 600 for the whole content,
                                                            ...
                                                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                <tr>
                                                                    <td valign="top" class="imageContent">
                                                                        <img src="http://edm2015.effektivart.com/ajtowebshop/vasarlas_visszaig/header1.jpg" width="600" class="flexibleImage" style="max-width:600px;width:100%;display:block;" alt="Text" title="Text" />
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                            <!-- // CONTENT TABLE -->
                                                                        ...
                                                                        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                            <tr>
                                                                                <td valign="top" class="textContent">
                                                                                    <h3 style="color:#0772B5;line-height:30%;font-family:Helvetica,Arial,sans-serif;font-size:20px;font-weight:bold;margin-top:0;margin-bottom:3px;text-align:center;">RENDELÉS ÉRKEZETT
</h3>
                                                                                    
                                                                                    <br></br>
                                                                                    <div style="color:#5F5F5F;line-height:30%;font-family:Helvetica,Arial,sans-serif;font-size:15px;font-weight:normal;margin-top:0;margin-bottom:20px;text-align:center;"> Megrendelő: <?php echo $details->name; ?> </div>
                                                                            
                                                                            
                                                                                                              <div style="text-align:center;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;margin-top:35px;color:#5F5F5F;line-height:135%;">Rendelésszám: <?php echo $details->id; ?></div>  
                                                                        
                                                               
                                                                                    <div style="text-align:center;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;margin-top:20px;color:#5F5F5F;line-height:135%;">Rendelt termékek:</div>
                                                                        ...
                                                                        <table border="0" cellpadding="0" cellspacing="0" width="210" style="max-width:47%;">
                                                                            <tr>
                                                                                <td align="center" class="textContent">
                                                                                    <img src="<?php echo base_url('uploads/files') . '/' . thumb_name(TERMEKLISTA_THUMB_WIDTH, $item->file_1_url); ?>" width="210" class="flexibleImage" style="max-width:47%;" align="center" alt="" title="" /> 
                                                                                </td>
                                                                            </tr>
                                                                        </table>
                                                                    </td>
